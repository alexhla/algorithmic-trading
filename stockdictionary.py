...
'GBNY', 'GBR', 'GBS', 'GIGM', 'GLBS', 'GNRS', 'GOED', 'GOVX',
'GTEC', 'GTIM', 'GURE', 'GWGH',

'HIHO', 'HJLI', 'HOTH', 'HTGM', 'HUDI', 'HUSA', 'HUSN', 'HX',

'ICD', 'ID', 'IFMK', 'IHT', 'IKNX', 'IKT', 'IMAC', 'IMRN',
'IMTE', 'INDO', 'INM', 'INVO', 'IPDN', 'IPWR', 'ISIG', 'ISNS',
'ISUN',

'JAKK', 'JAN', 'JCS', 'JCTCF', 'JILL', 'JMP', 'JP', 'JRSH',
'JUPW', 'JVA',
...
'MITC', 'MITO', 'MKTY', 'MNPR', 'MOSY', 'MOXC', 'MRIN', 'MSN',
'MTBC', 'MTC', 'MTP', 'MTR', 'MTSL', 'MVO', 'MXC', 'MYMD',
'MYO', 'MYT',
...
'PALI', 'PBLA', 'PBTS', 'PCSA', 'PFIN', 'PHCF', 'PIXY', 'PLAG',
...
'SSNT', 'SSY', 'STRR', 'SVT', 'SYNL', 'SYTA',

'TAIT', 'TAOP', 'TATT', 'TC', 'TESS', 'THMO', 'TRMT', 'TRT',
'TSRI', 'TTNP', 'TURN',

'UFAB', 'UGRO', 'USAP', 'USDP', 'USEG', 'UUU',


'VINO', 'VIRI', 'VIVE', 'VLON', 'VMAR', 'VRME', 'VRPX', 'VTSI',
'VVPR', 'VYNT',

'WAFU', 'WHLM', 'WHLR', 'WINT', 'WISA', 'WKEY', 'WORX', 'WYY',
